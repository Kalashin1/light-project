...
<div class="py-4 bg-black text-white">
  <h1 class="mt-8 font-bold text-white text-center text-3xl">
    Contact Details
  </h1>
    ...
    <div class="flex flex-col w-full lg:w-2/5 p-8">
      ...
      <p class="font-sans text-sm md:text-lg my-2 md:my-4">
        ...
        >
          ...
          />
        </svg>Ibrahim Taiwo Road, Illorin, Kwara State.
      </p>
      <p class="font-sans text-sm md:text-lg my-2 md:my-4">
        <svg
          class="inline-block fill-current mr-2"
        ...
        >
          ...
          />
        </svg> emmanuelObediah7@gmail.com
      </p>
      <p class="font-sans text-sm md:text-lg my-2 md:my-4">
        <svg
          class="inline-block fill-current mr-2"
        ...
        >
          ...
          />
        </svg>+2348161999108, &nbsp; +2348157362194
      </p>
      <br /> <br />
